...
trigger_sending(event_dict['Test'], default_sleep=True)  # trigger 254 represents main experiment
# -----------------------------------------------------------------------------------
# ------------------------ Setting: Initialization ----------------------------------
# -----------------------------------------------------------------------------------
if init_flag:

    expInfo, win, frameDur, defaultKeyboard  = exp_init(fade_flag=False, pause_flag=False)
